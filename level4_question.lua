...
function scene:create( event )
    ...
    correctObject = display.newText("Correct!", display.contentWidth/2, display.contentHeight*1/3, Arial, 35)
    correctObject.isVisible = false
    correctObject:setFillColor(0,1,0)

    incorrectObject = display.newText("Incorrect", display.contentWidth/2, display.contentHeight*1/3, Arial, 35)
    incorrectObject.isVisible = false
